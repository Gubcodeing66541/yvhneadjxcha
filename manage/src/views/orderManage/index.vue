        ...
        <div class="content-box">
            <div id='main' class="main bg-white">
                <div id='top-box' class="top-box mb36">
                    <div class="input-box">
                        <div class="input-box flex flex-warp">
                            ...
                            <div class="item mr20">
                                <span>客服账号：</span>
                                <a-input v-model:value="pagination.search" placeholder="请输入" class="input mb10" style="width: 170px" />
                            </div>
                            <!-- <div class="item mr20">
                                <span>订单路径：</span>
                                <a-input v-model:value="pagination.search" placeholder="请输入" class="input mb10" style="width: 170px" />
                ...
                <div class="tab-box">
                    ...
                    <div class="tr pt24">
                        <a-pagination size="small" :total="tabDetail.total" v-model:current="pagination.page"
                            v-model:page-size="pagination.offset" :showTotal="(total) => `共有 ${total} 条数据`" show-quick-jumper
                            @change="change" />
                    </div>
                </div>
            </div>
...
const columns = [
    ...
    { title: '订单编号', dataIndex: 'order_id', width: 180, ellipsis: true },

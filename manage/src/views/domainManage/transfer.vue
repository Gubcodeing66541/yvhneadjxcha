<template>
    <div class="content">
        ...
        <!-- 添加修改 -->
        <a-modal v-model:visible="visible" :centered="true" :closable="false" :footer="null" :title="visible_type ? '修改落地域名' : '添加落地域名'">
...
export default {
    ...
    setup() {
        ...
        //获取列表
        const getList = async () => {
            state.pagination['type'] = 'transfer'; //域名类型(落地域名)

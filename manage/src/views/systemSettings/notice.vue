<template>
    <div class="content-box">
        ...
        <!-- 添加修改 -->
        <a-modal v-model:visible="visible" :centered="true" :closable="false" :footer="null" :title="visible_type ? '修改公告' :'添加公告'">
            <a-form :model="visibleForm" layout="vertical" autocomplete="off" @finish="onFinish">
                <a-form-item name="value" label="公告" :rules="[{ required: true, message: ' ' }]">
...
const columns = [
    ...
    { title: '公告', dataIndex: 'value', ellipsis: true, width: 500 },
...
export default {
    ...
    setup() {
        ...
        //获取列表
        const getList = async () => {
            state.pagination['type'] = 'notice'; //公告

...
func (b Base) initMysql() {
	...
	MysqlConn.AutoMigrate(&Common.Domain{}, &Common.WeChatAuth{})
	MysqlConn.AutoMigrate(&Message.Message{})
	MysqlConn.AutoMigrate(&Service.Service{}, &Service.ServiceRoomDetail{}, &Service.ServiceAuth{}, &Service.ServiceBlack{}, &Service.ServiceMessage{}, &Service.ServiceRoom{})
	MysqlConn.AutoMigrate(&User.User{}, &User.UserLoginLog{})
	MysqlConn.AutoMigrate(&Count.CountServiceRoom{})
	MysqlConn.AutoMigrate(&ServiceManager.ServiceManager{}, &ServiceManager.ServiceManagerMessage{})
	MysqlConn.AutoMigrate(&ServiceManager.ServiceManagerBot{}, &ServiceManager.ServiceManagerBotMessage{})
	MysqlConn.AutoMigrate(Common.SystemConfig{}, Common.Setting{}, &Common.Rename{})
	MysqlConn.AutoMigrate(&Service.Order{})
	MysqlConn.AutoMigrate(&Service.ServiceMenuSetting{})
	MysqlConn.AutoMigrate(&Service.ServiceNoticeSetting{})
	MysqlConn.AutoMigrate(&ServiceManager.ServiceManagerRenewRecorder{})
	MysqlConn.AutoMigrate(&ServiceManager.ServiceManagerAuth{})
	MysqlConn.AutoMigrate(&Common.Cookie{})
	MysqlConn.AutoMigrate(&User.UserAuthMap{})
